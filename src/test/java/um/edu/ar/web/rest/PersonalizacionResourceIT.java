...
class PersonalizacionResourceIT {
     ...
     */
    public static Personalizacion createEntity() {
        return new Personalizacion().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static Personalizacion createUpdatedEntity() {
        return new Personalizacion().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
    }

    @BeforeEach
    public void initTest() {
        personalizacion = createEntity();
    }
