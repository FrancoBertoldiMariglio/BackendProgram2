...
import static um.edu.ar.domain.AdicionalAsserts.*;
...
class AdicionalResourceIT {
     ...
     */
    public static Adicional createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Adicional createUpdatedEntity() {
        return new Adicional()
    ...
    void partialUpdateAdicionalWithPatch() throws Exception {
        ...
        partialUpdatedAdicional.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).precioGratis(UPDATED_PRECIO_GRATIS);
