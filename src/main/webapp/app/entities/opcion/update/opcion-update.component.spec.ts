...
describe('Opcion Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Personalizacion query and add missing value', () => {
      ...
      const personalizacion: IPersonalizacion = { id: 27749 };
      opcion.personalizacion = personalizacion;

      const personalizacionCollection: IPersonalizacion[] = [{ id: 27274 }];
    ...
    it('Should update editForm', () => {
      const opcion: IOpcion = { id: 456 };
      const personalizacion: IPersonalizacion = { id: 17263 };
      opcion.personalizacion = personalizacion;
